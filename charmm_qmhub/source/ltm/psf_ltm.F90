module psf
  ...
  real(chm_real),allocatable,dimension(:) :: CG, AMASS, RSCLF, ALPHADP, THOLEI, CG_DUM ! /*RAAFIK 2023 */ Added for QMHUB gukini.F90
#if KEY_WCA==1
...
contains
  ...
  subroutine allocate_psf_ltm()
    ...
    call chmalloc(file_name,routine_name,'cg_dum    ',maxaim  ,crl=cg_dum) ! /*RAAFIK 2023 */ Added for QMHUB gukini.F90
